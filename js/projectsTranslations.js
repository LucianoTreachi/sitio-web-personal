export const projectsTranslations = {
  es: {
    ...
    project1Paragraph1: "<b>Descripción del proyecto:</b> Diseñé y desarrollé un modelo de Currículum Vitae Web, una opción creativa para mostrar nuestro resumen de vida. La página es 100% responsiva, se adapta perfectamente a cualquier dispositivo: escritorio, tablet y móvil. Además, cuenta con la funcionalidad de Dark Mode, permitiendo cambiar a un modo oscuro para mayor comodidad visual.",
    ...
    project5Paragraph1: "<b>Descripción del proyecto:</b> Diseñé y desarrollé un sitio web para la provincia de Córdoba, ubicada en Argentina. El sitio muestra 80 lugares turísticos para visitar. Es 100% responsivo, se adapta perfectamente a cualquier dispositivo: escritorio, tablet y móvil.",
    ...
    project7Paragraph2: "<b>Tecnologías utilizadas:</b> Vite, React Js, Cloudinary, Firebase.",
    ...
    project9Paragraph2: "<b>Tecnologías utilizadas:</b> Vite, React Js, CSS module, Cloudinary.",
  },
  ...
  en: {
    ...
    /* Project 1 */
    project1Title: "Curriculum Vitae Web",
    project1Paragraph1: "<b>Project Description:</b> I designed and developed a Web Resume model, a creative option to showcase our life summary. The page is 100% responsive, adapting seamlessly to any device: desktop, tablet, and mobile. Furthermore, it features Dark Mode functionality, allowing a switch to a dark mode for enhanced visual comfort.",
    ...
    /* Project 5 */
    project5Title: "Conociendo Córdoba",
    project5Paragraph1: "<b>Project Description:</b> I designed and developed a website for the province of Córdoba, located in Argentina. The site showcases 80 tourist destinations to visit. It's 100% responsive, adapting seamlessly to any device: desktop, tablet, and mobile.",
    ...
    project7Paragraph2: "<b>Technologies Used:</b> Vite, React Js, Cloudinary, Firebase.",
    ...
    project9Paragraph2: "<b>Technologies Used:</b> Vite, React Js, CSS module, Cloudinary.",
  },
  ...
  pt: {
    ...
    /* Project 1 */
    project1Title: "Curriculum Vitae Web",
    project1Paragraph1: "<b>Descrição do projeto:</b> Criei e desenvolvi um modelo de Currículo Vitae Web, uma opção criativa para exibir nosso resumo de vida. A página é 100% responsiva, adaptando-se perfeitamente a qualquer dispositivo: desktop, tablet e celular. Além disso, possui a funcionalidade de Modo Escuro, permitindo a mudança para um modo escuro para maior conforto visual.",
    ...
    /* Project 5 */
    project5Title: "Conociendo Córdoba",
    project5Paragraph1: "<b>Descrição do projeto:</b> Criei e desenvolvi um site para a província de Córdoba, localizada na Argentina. O site apresenta 80 locais turísticos para visitar. É 100% responsivo, adaptando-se perfeitamente a qualquer dispositivo: desktop, tablet e celular.",
    ...
    project7Paragraph2: "<b>Tecnologias utilizadas:</b> Vite, React Js, Cloudinary, Firebase.",
    ...
    project9Paragraph2: "<b>Tecnologias utilizadas:</b> Vite, React Js, CSS module, Cloudinary.",
  }
};