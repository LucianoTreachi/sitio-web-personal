...
function changeTheme() {
  ...
  const themeButton = document.querySelector(".theme-toggle-svg");

  const getCurrentTheme = () => body.classList.contains(darkTheme) ? "dark" : "light";

  // If there is no theme stored in localStorage, assume light theme and load sun icon
  if (!selectedTheme) {
    ...
    if (themeButton) {
      themeButton.innerHTML = selectedTheme === "dark" ? `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
